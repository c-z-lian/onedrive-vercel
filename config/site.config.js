...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Show@localjoy.onmicrosoft.com',
  ...
  email: 'mailto:localjoy.c@gmail.com',
